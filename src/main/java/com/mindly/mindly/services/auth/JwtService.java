...
import com.mindly.mindly.config.RsaKeyProperties;
...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        try {
            ...
            throw new RuntimeException("Erro em extrair o token", e);
        }
    }
    ...
    public String extractUsername(String token) {
        try {
            ...
            throw new RuntimeException("Erro em extrair o username", e);
        }
    }
